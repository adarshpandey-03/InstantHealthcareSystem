<%-- 
    Document   : dashboard
    Created on : Mar 29, 2021, 2:23:22 PM
    Author     : Adarsh
--%>
...
<%@page import="Helper.DatabaseConnector" %>
...
<html>
    ...
    <div class="maincontent ">
        ...
        <%
            try {
             ...
             for (permissionForm_entities c : list) {*/
                ...
                String query = "select * from offlineappointmentdetails";
        ...
        <div class="req mb-3 border">
            <h5 class="pm pl-3">AppointmentID:- <%= set.getInt("appointmentID")%></h5>
            <p><h5 class="pl-3">
                Problem: - <%= set.getString("problem")%></h5></p>
            <div class="row">
            <div class="pl-3 col-3 ml-4"> <button class="btn btn-success mr-4 pl-2"> Complete </button>
                <button class="btn btn-danger">Pending </button></div>               
                
                <img id="myImg" src="Screenshot (223).png" alt="Report" style="width:100%;max-width:300px">

            <!-- The Modal -->
            <div id="myModal" class="modal col-3">
                <span class="close">&times;</span>
                <img class="modal-content" id="img01">
                <div id="caption"></div>
            </div>
            </div>
            <div class="font-weight-bold pm mt-3 pl-3"><span class="mr-5">Name:- <%= set.getString("fullname")%></span><span class="mr-5">Phone No.:- <%= set.getString("phone")%></span><span class="mr-5">Age:-<%= set.getString("age")%></span></div>
        </div>
